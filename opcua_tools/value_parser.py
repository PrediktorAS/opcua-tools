...
simple = {'Boolean', 'SByte', 'Byte', 'Int16', 'UInt16', 'Int32', 'UInt32', 'Int64', 'UInt64', 'Float',
                  'Double', 'String', 'DateTime', 'Guid', 'ByteString', 'NodeId'}
...
def parse_singular_value(val, tagtype):
    if tagtype in simple:
        ...
        if parsed_typeid is not None and type(parsed_typeid) == UANodeId:
            if parsed_typeid.namespace == 0 and parsed_typeid.nodeid_type == NodeIdType.NUMERIC and parsed_typeid.value == '888':
        ...
        return UnparsedUAExtensionObject(type_nodeid=parsed_typeid,
                                 body=parsednextbody)
